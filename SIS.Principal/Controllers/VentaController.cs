    ...
    public class VentaController : Controller
    {
        ...
        public void InstRegistrarVenta(EVenta oDatos, List<EVentaDetalle> Detalle)
        {
            try
            {
                ...
                var tipoSistema = "SEE";
                var sMensaje = Venta.RegistrarVenta(oDatos, Detalle, Usuario, tipoSistema, ruta, rutaServidor, claveCertificado);
        ...
        [HttpPost]
        public void InstRegistrarPost(EVenta oDatos, List<EVentaDetalle> Detalle)
        {
            try
            {
                var Usuario = Authentication.UserLogued.Usuario;
                ...
                var claveCertificado = Empresa.ClaveCertificado;
                var tipoSistema = "SEE";
                var sMensaje = Venta.RegistrarPost(oDatos, Detalle, Usuario, tipoSistema, ruta, rutaServidor, claveCertificado);
                Utils.WriteMessage(sMensaje, Utils.WithAdditionals);
            }
            catch (Exception Exception)
            {
        ...
        [HttpPost]
        public void ListaVenta(string filtro, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant, string vendedor)
        {
            try
            {
                int empresa = Authentication.UserLogued.Empresa.Id;
                ...
                Utils.Write(
                    ResponseType.JSON,
                    Venta.ListaVenta(filtro, empresa, sucursal, FechaIncio, FechaFin, numPag, allReg, Cant, vendedor)
                );
            }
            catch (Exception Exception)
            {
        ...
        public void ConsultaStock(int idProducto, int almacen, double iCantidad)
        {
            try
            {
                ...
                var mensaje = Venta.VerificarStock(empresa, almacen, sucursal, idProducto, iCantidad);
        ...
        [HttpPost]
        public void elimiarVenta(EVenta oDatos, List<EVentaDetalle> Detalle, string usuario)
        {
            try
            {
                var Usuario = Authentication.UserLogued.Usuario;
        ...
        [HttpPost]
        public void ListaVentaEnvios(string filtro, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant)
        {
            try
            {
                int empresa = Authentication.UserLogued.Empresa.Id;
                ...
                Utils.Write(
                    ResponseType.JSON,
                    Venta.ListaVentaEnvios(filtro, empresa, sucursal, FechaIncio, FechaFin, numPag, allReg, Cant)
                );
            }
            catch (Exception Exception)
            {
        ...
        [HttpPost]
        public void EstadoEnviado(int IdVenta, string Motivo, int Flag)
        {
            try
            {
                var Usuario = Authentication.UserLogued.Usuario;
                ...
                Utils.WriteMessage(Venta.EstadoEnviado(IdVenta, Empresa, Motivo, Flag, Usuario));
            }
            catch (Exception Exception)
            {
                Utils.Write(
        ...
        //reporte
        #region Reporte PDF
        public ActionResult ReportePDF(string filtro, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant, int venta, string vendedor)
        {
            ...
            if (venta == 1)
            {
                ListaCompra = Venta.ListaVenta(filtro, empresa, sucursal, FechaIncio, FechaFin, numPag, allReg, Cant, vendedor);
            }
            else
            {
            ...
            if (ListaCompra.Count > 0)
            {
                ...
                PdfPCell cFechaPago = new PdfPCell(new Phrase("Ope. Grab.", _standardFont));
                cFechaPago.Border = 1;
        ...
        public ActionResult ReporteExcel(string cliente, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant, int venta,string vendedor)
        {
            try
            {
                ...
                if (venta == 1)
                {
                    ListaCompra = Venta.ListaVenta(cliente, Empresa, sucursal, FechaIncio, FechaFin, numPag, allReg, Cant, vendedor);
                ...
                foreach (EVenta Detalle in ListaCompra)
                {
                    ...
                    ws.Cells[iFilaDetIni + starRow, 10].Value = Math.Round(Convert.ToDouble(Detalle.inafecta), 2);
                    ws.Cells[iFilaDetIni + starRow, 11].Value = Math.Round(Convert.ToDouble(Detalle.exonerada), 2);
                    ...
                    ws.Cells[iFilaDetIni + starRow, 14].Value = Math.Round(Convert.ToDouble(Detalle.descuento), 2);
                    ws.Cells[iFilaDetIni + starRow, 15].Value = Math.Round(Convert.ToDouble(Detalle.CostoEnvio), 2);
                    ws.Cells[iFilaDetIni + starRow, 16].Value = Detalle.Text;
                    ws.Cells[iFilaDetIni + starRow, 17].Value = Detalle.Nombre;
                ...
                ws.Cells[iFilaDetIni + (Count - 1), 10].Value = Math.Round(Convert.ToDouble(exonerada), 2);
                ws.Cells[iFilaDetIni + (Count - 1), 11].Value = Math.Round(Convert.ToDouble(inafecta), 2);
                ...
                ws.Cells[iFilaDetIni + (Count - 1), 14].Value = Math.Round(Convert.ToDouble(descuento), 2);

                string modelRange = "A" + System.Convert.ToString(iFilaDetIni) + ":Q" + (iFilaDetIni + Count - 1).ToString();
        ...
        public ActionResult imprimirFacBol(int Id, int Envio, int venta)
        {
            ...
            try
            {
                ...
                iTextSharp.text.Font _standardFontTabla = new iTextSharp.text.Font(iTextSharp.text.Font.HELVETICA, 8, iTextSharp.text.Font.BOLD, Color.BLACK);
                ...
                PdfPCell celEmail = new PdfPCell(new Phrase("Tienda:Jr Andahuaylas N° 1049 int.154-155 Lima-cel.993179993/933453890", _standarTexto));
                celEmail.HorizontalAlignment = 0;
                celEmail.Border = 0;
                //celTelefono.Colspan = 2;
                tableIzq.AddCell(celEmail);

                PdfPCell celdireccion1 = new PdfPCell(new Phrase("Tienda:Jr Andahuaylas N° 1057 Lima-cel.946079180/934911278", _standarTexto));
                celdireccion1.HorizontalAlignment = 1;
                celdireccion1.Border = 0;
                //celTelefono.Colspan = 2;
                tableIzq.AddCell(celdireccion1);

                PdfPCell celdireccion2 = new PdfPCell(new Phrase("Tienda:Jr Andahuaylas N° 880 Lima-cel.960738708/933458254", _standarTexto));
                celdireccion2.HorizontalAlignment = 1;
                celdireccion2.Border = 0;
                //celTelefono.Colspan = 2;
                tableIzq.AddCell(celdireccion2);

                PdfPCell celdireccion3 = new PdfPCell(new Phrase("Almacen:Jr. Lorenzo Vidaurre N° 163 Cercado de Lima cel: Feng 933454878", _standarTexto));
                celdireccion3.HorizontalAlignment = 0;
                celdireccion3.Border = 0;
                //celTelefono.Colspan = 2;
                tableIzq.AddCell(celdireccion3);

                PdfPCell celdireccion4 = new PdfPCell(new Phrase("SIN GARANTIA", _standarTitulo));
                celdireccion4.HorizontalAlignment =1;
                celdireccion4.Border = 0;
                //celTelefono.Colspan = 2;
                tableIzq.AddCell(celdireccion4);
                ...
                PdfPCell cTipoDoc = new PdfPCell(new Phrase(imprimir[0].Comprobante.Nombre , _standarTitulo));
                ...
                PdfPCell cTitulo31 = new PdfPCell(new Phrase("TELÉFONO:", _standardFont));
                cTitulo31.Border = 0;
                cTitulo31.HorizontalAlignment = 0;
                cTitulo31.BorderWidthLeft = 1f;
                cTitulo31.Padding = 5;
                TableCab.AddCell(cTitulo31);

                PdfPCell CTELEFONO = new PdfPCell(new Phrase(imprimir[0].Venta.cliente.Telefono, _standardFont));
                CTELEFONO.Border = 0;
                CTELEFONO.HorizontalAlignment = 0;
                CTELEFONO.BorderWidthRight = 1f;
                CTELEFONO.Padding = 5;
                TableCab.AddCell(CTELEFONO);
               ...
               // cTituloDesc.BackgroundColor = new Color(System.Drawing.Color.MidnightBlue);
                ...
                PdfPCell cTituloDescuento = new PdfPCell(new Phrase("CÓDIGO", _standardFontTabla));
                cTituloDescuento.BorderWidthBottom = 1;
                ...
                PdfPCell cTituloCant = new PdfPCell(new Phrase("DESCRIPCIÓN", _standardFontTabla)); 
                cTituloCant.BorderWidthBottom = 1;
              ...
              //  cTituloPrecio.BackgroundColor = new Color(System.Drawing.Color.MidnightBlue);
                ...
                foreach (EVentaDetalle ListaRep in imprimir)
                {
                    ...
                    PdfPCell celldescuento = new PdfPCell(new Phrase(ListaRep.material.sCodigo, _standardFont));
                ...
                // cCeldaDetalle.FixedHeight = 440f;
                tblPrueba.AddCell(cCeldaDetalle);
                ...
                */
                ...
                cTituloImporte.BorderWidthTop = 1f;
                ...
                cCeldaTotalDoc.BorderWidthTop = 1f;
                ...
                if (Envio == 0)//enviar documento
                {
                    ...
                    var archivo = path;
                    if (imprimir[0].Venta.cliente.Email != "-" && imprimir[0].Venta.cliente.Email != null)
                    {
        ...
        public ActionResult ImprimirFacturaBolTikect(int Id)
        {
            ...
            try
            {
                ...
                PdfPCell cTituloSub = new PdfPCell(new Phrase("Ope. GRABADA:", _standarTexto));
                cTituloSub.Border = 0;
        ...
        public ActionResult ImprimirNotaCreditoDebito(string Codigo, int Envio)
        {
            ...
            try
            {
                ...
                if (Envio == 0)//enviar documento
                {
                    ...
                    var archivo = path;
                    if (debito[0].Venta.cliente.Email != "-")
                    {
