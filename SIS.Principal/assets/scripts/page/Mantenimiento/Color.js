...
$(function () {
    ...
    var table = $("#tbColor").DataTable({
        ...
        "order": [],
        "ajax": {
            "url": General.Utils.ContextPath('Mantenimiento/ListaColor'),
    ...
    $("#btnGrabar").click(function () {
        ...
        if (General.Utils.ValidateForm($form)) {
            ...
            $.ajax({
                async: true,
                type: 'post',
                url: General.Utils.ContextPath('Mantenimiento/Insertar_UpdateColor'),
                dataType: 'json',
                data: {
                    eMenu: oDatos
                },
...
var Obtener = function (Id) {
    ...
    $.ajax({
        async: true,
        type: 'post',
        url: General.Utils.ContextPath('Mantenimiento/ListaEditColor'),
        dataType: 'json',
        data: senData,
        success: function (response) {
            console.log(response);
