...
$(function () {
    ...
    var table = $("#tbMarca").DataTable({
        ...
        "order": [],
        "ajax": {
            "url": General.Utils.ContextPath('Mantenimiento/ListaMarca'),
    ...
    $("#btnGrabar").click(function () {
        ...
        if (General.Utils.ValidateForm($form)) {
            ...
            $.ajax({
                async: true,
                type: 'post',
                url: General.Utils.ContextPath('Mantenimiento/InstMarca'),
                dataType: 'json',
                data: oDatos,
                success: function (response) {                   
    ...
    $("#tbMarca").on('click', 'tbody .Eliminar', function () {
...
var Obtener = function (Id) {
    ...
    $.ajax({
        async: true,
        type: 'post',
        url: General.Utils.ContextPath('Mantenimiento/ListaEditMarca'),
        dataType: 'json',
        data: senData,
        success: function (response) {
            console.log(response);
            $("#hdfId").val(response.IdMarca);
