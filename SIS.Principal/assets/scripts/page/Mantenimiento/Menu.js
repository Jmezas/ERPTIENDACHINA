...
$(function () {
    ...
    var table = $("#tbMenu").DataTable({
        ...
        "order": [],
        "ajax": {
            "url": General.Utils.ContextPath('Mantenimiento/ListadoMenu'),
        ...
        "columns": [
            ...
            { "data": "Controlador" },
            {
                ...
                "render": function (data) {
                    //console.log(data)
                    var html = '<span class="badge badge-success"><i class="' + data + '"></i></span>';
    ...
    $("#btnGrabar").click(function () {
        ...
        $.ajax({
            async: true,
            type: 'post',
            url: General.Utils.ContextPath('Mantenimiento/RegistrarMenu'),
            dataType: 'json',
            data: oCliente,
            success: function (response) {
...
var Obtener = function (Id) {
    ...
    $.ajax({
        async: true,
        type: 'post',
        url: General.Utils.ContextPath('Mantenimiento/BuscarMenuId'),
        dataType: 'json',
        data: senData,
        success: function (response) {
            //console.log(response);
