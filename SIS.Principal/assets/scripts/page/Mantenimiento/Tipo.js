...
$(function () {
    ...
    var table = $("#tbTipo").DataTable({
        ...
        "order": [],
        "ajax": {
            "url": General.Utils.ContextPath('Mantenimiento/Listadotipo'),
    ...
    $("#btnGrabar").click(function () {
        ...
        if (General.Utils.ValidateForm($form)) {
            ...
            $.ajax({
                async: true,
                type: 'post',
                url: General.Utils.ContextPath('Mantenimiento/RegistrarTipo'),
                dataType: 'json',
                data: {
                    eMenu: oDatos
                },
    ...
    $("#tbTipo").on('click', 'tbody .Eliminar', function () {
...
var Obtener = function (Id) {
    ...
    $.ajax({
        async: true,
        type: 'post',
        url: General.Utils.ContextPath('Mantenimiento/BuscarTipoId'),
        dataType: 'json',
        data: senData,
        success: function (response) {
            console.log(response);
            ...
            $("#lstLinea").val(response.lstLinea);
        }
