...
$(function () {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#lstLinea").append($('<option>', { value: 0, text: 'Seleccione' }));
    ...
    var table = $("#tbCategoria").DataTable({
        ...
        "order": [],
        "ajax": {
            "url": General.Utils.ContextPath('Mantenimiento/ListaCategoria'),
        ...
        "columns": [
            ...
            { "data": "Sigla" },
            {
                "data": "IdCateogira", "render": function (data) {
    ...
    $("#btnGrabar").click(function () {
        ...
        if (General.Utils.ValidateForm($form)) {
            ...
            $.ajax({
                async: true,
                type: 'post',
                url: General.Utils.ContextPath('Mantenimiento/InstCategoria'),
                dataType: 'json',
                data: oDatos,
                success: function (response) {
...
var Obtener = function (Id) {
    ...
    $.ajax({
        async: true,
        type: 'post',
        url: General.Utils.ContextPath('Mantenimiento/ListaEditCategoria'),
        dataType: 'json',
        data: senData,
        success: function (response) {
            console.log(response);
            $("#hdfId").val(response.IdCateogira);
            $("#txtNombre").val(response.Nombre);
            $("#txtSigla").val(response.Sigla);
            $("#lstLinea").val(response.IdLinea);
