...
namespace SIS.Business
{
    public class BReportes
    {
        ...
        public List<EVentaDetalle> ResumenVentasXProductoPOS(string filtro, int Empresa, string rolUsuario, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant, string vendedor, int sucursal)
        {
            try
            {
                return Data.ResumenVentasXProductoPOS(filtro, Empresa, rolUsuario, FechaIncio, FechaFin, numPag, allReg, Cant, vendedor, sucursal);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<EVenta> VentasGeneralesPos(string filtro, int Empresa, int sucursal, string rolUsuario, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant)
        {
            try
            {
                return Data.VentasGeneralesPos(filtro, Empresa, sucursal, rolUsuario, FechaIncio, FechaFin, numPag, allReg, Cant);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<EVentaDetalle> VentasPorTipoPagoPos(string filtro, int Empresa, int sucursal, string rolUsuario, string FechaIncio, string FechaFin, int numPag, int allReg, int Cant)
        {
            try
            {
                return Data.VentasPorTipoPagoPos(filtro, Empresa, sucursal, rolUsuario, FechaIncio, FechaFin, numPag, allReg, Cant);
            }
            catch (Exception ex)
            {
                throw ex;
