        ...
        public string InstCliente(ECliente Cliente, string Usuario)
        {
            using (var Connection = GetConnection(BaseDeDatos))
            {
                try
                {
                    ...
                    AddInParameter("@sIdDep", Cliente.Ubigeo.CodigoDepartamento);
                    AddInParameter("@sIdProv", Cliente.Ubigeo.CodigoProvincia);
                    AddInParameter("@sIdDistrito", Cliente.Ubigeo.CodigoDistrito);
